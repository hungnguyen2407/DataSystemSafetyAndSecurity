...
public class CaesarCipher {
    ...
    public static String encrypt(String plainText, String key) {
        ...
        for (char c : pt) {
            if (Character.isAlphabetic(c)) {
                cipherText.append(numberToAlphabet((alphabetToNumber(Character.toUpperCase(c)) + Integer.parseInt(key)) % 22));
            } else {
                cipherText.append(c);
            }
        }
    ...
    public static String decrypt(String cipherText, String key) {
        ...
        for (char c : ct) {
            if (Character.isAlphabetic(c)) {
                plainText.append(numberToAlphabet((alphabetToNumber(c) - Integer.parseInt(key)) % 22));
            } else {
                plainText.append(c);
            }
        }
